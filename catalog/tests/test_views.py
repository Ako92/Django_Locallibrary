...
if __name__ == '__main__':
    class AuthorListViewTest(TestCase):
        ...
        def setUpTestData(cls):
            ...
            for author_num in range (number_of_authors):
                Author.objects.create(first_name='Ali %s' %author_num, last_name='HK %s' %author_num,)
    ...
    class LoanedBookInstancesByUserListViewTest(TestCase):
        ...
        # create Books
            test_author = Author.objects.create(first_name='ali',last_name='hk')
            test_genre = Genre.objects.create(name='fantasy')
            test_language = Language.objects.create(name='English')
            test_book = Book.objects.create(title='book title',summary='myBookSummary',isbn='1987137119611',
        ...
        #create Genre as a post Step
         ...
         # create 30 Book instances Object
            ...
            for book_copy in range(number_of_book_copies):
                ...
                status = 'm'
                BookInstance.objects.create(book=test_book,imprint='unlikeny imprint, 2017',due_back=return_date,
        ...
        def test_only_borrowed_books_in_list(self):
            ...
            self.assertEqual(len(resp.contex['bookinstance_list']),0)
            ...
            # confirm all books are belong to testuser1 and are all on loan
